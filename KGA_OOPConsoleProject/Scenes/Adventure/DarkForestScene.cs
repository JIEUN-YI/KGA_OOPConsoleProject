...
namespace KGA_OOPConsoleProject.Scenes.Adventure
{
    public class DarkForestScene : Scene
    {
        ...
        public override void Enter()
        {
           ...
           /* 1*/{ false,  true,  true, false, false,  true,  true,  true,  true,  true,  true,  true,  true, false, false, false, false, false },
           /* 2*/{ false,  true,  true,  true, false,  true, false, false, false,  true, false, false,  true, false, false, false,  true, false },
           /* 3*/{ false, false,  true,  true,  true,  true,  true, false, false,  true, false, false, false, false, false,  true,  true, false },
           /* 4*/{ false, false, false,  true,  true, false,  true,  true,  true, false, false, false, false, false, false,  true, false, false },
           /* 5*/{ false, false, false,  true, false, false,  true, false,  true,  true, false, false,  true,  true, false,  true,  true, false },
           /* 6*/{ false, false, false,  true, false, false,  true, false, false,  true,  true,  true, false,  true, false, false,  true, false },
           /* 7*/{ false, false, false,  true, false, false,  true,  true, false, false, false,  true, false,  true, false, false,  true, false },
           /* 8*/{ false, false, false,  true, false, false, false,  true,  true, false, false, false, false,  true,  true, false,  true, false },
           /* 9*/{ false, false,  true,  true, false, false, false, false,  true,  true, false, false, false, false,  true, false,  true, false },
           /*10*/{ false,  true,  true, false, false, false, false, false, false,  true, false, false,  true, false,  true, false,  true, false },
           /*11*/{ false,  true, false, false, false, false, false, false, false,  true, false,  true,  true, false,  true,  true,  true, false },
           /*12*/{ false,  true, false, false, false, false, false, false,  true,  true, false,  true,  true, false,  true,  true, false, false },
           /*13*/{ false,  true, false, false, false, false, false, false,  true, false, false, false,  true,  true,  true,  true, false, false },
           /*14*/{ false,  true, false, false, false,  true,  true,  true,  true, false, false, false, false,  true, false,  true,  true, false },
           /*15*/{ false,  true, false, false,  true,  true, false, false,  true,  true, false,  true, false, false, false, false,  true, false },
           /*16*/{ false,  true,  true, false,  true, false, false, false,  true,  true,  true,  true,  true,  true,  true,  true,  true, false },
